...
async def status() -> dict:
    ...
    return {
        ...
        "grading_embedding_model": settings.GRADING_EMBEDDING_MODEL,
        "total_documents": len(docs),
        "total_chunks": indexing_service.total_chunks(),
        "curriculum_chunks": collection_count(settings.CURRICULUM_COLLECTION),
        "grading_memory_chunks": collection_count(settings.GRADING_MEMORY_COLLECTION),
    }

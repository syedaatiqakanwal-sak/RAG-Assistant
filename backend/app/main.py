...
from app.api import auth, chat, curriculum, documents, grade, stats
...
app = FastAPI(
    ...
    description="RAG API with academic assignment grading (ChromaDB + Ollama).",
)
...
app.include_router(grade.router, prefix=api_prefix)
...
async def api_root() -> dict:
    return {
        ...
        "endpoints": [
            ...
            "GET  /api/grade/{assignment_id}",
            "POST /api/grade/{assignment_id}/review",
            "GET  /api/stats",
            "GET  /api/activity",
            "WS   /api/ws/status",
        ],
